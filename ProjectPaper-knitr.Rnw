...
bptd0405 = barplot(avgbytermdegdept0405,main="Average Time Between Bachelers and Terminal Degree by Department 2004-2005",ylab="Time(Years)",las=2,ylim=c(0,20),col=rainbow(42))
bptd0506 = barplot(avgbytermdegdept0506,main="Average Time Between Bachelers and Terminal Degree by Department 2005-2006",ylab="Time(Years)",las=2,ylim=c(0,20),col=rainbow(42))
bptd0607 = barplot(avgbytermdegdept0607,main="Average Time Between Bachelers and Terminal Degree by Department 2006-2007",ylab="Time(Years)",las=2,ylim=c(0,20),col=rainbow(42))
bptd0708 = barplot(avgbytermdegdept0708,main="Average Time Between Bachelers and Terminal Degree by Department 2007-2008",ylab="Time(Years)",las=2,ylim=c(0,20),col=rainbow(42))
bptd0809 = barplot(avgbytermdegdept0809,main="Average Time Between Bachelers and Terminal Degree by Department 2008-2009",ylab="Time(Years)",las=2,ylim=c(0,20),col=rainbow(42))
bptd0910 = barplot(avgbytermdegdept0910,main="Average Time Between Bachelers and Terminal Degree by Department 2009-2010",ylab="Time(Years)",las=2,ylim=c(0,20),col=rainbow(42))
bptd1011 = barplot(avgbytermdegdept1011,main="Average Time Between Bachelers and Terminal Degree by Department 2010-2011",ylab="Time(Years)",las=2,ylim=c(0,15),col=rainbow(42))
bptd1112 = barplot(avgbytermdegdept1112,main="Average Time Between Bachelers and Terminal Degree by Department 2011-2012",ylab="Time(Years)",las=2,ylim=c(0,20),col=rainbow(42))
bptd1213 = barplot(avgbytermdegdept1213,main="Average Time Between Bachelers and Terminal Degree by Department 2012-2013",ylab="Time(Years)",las=2,ylim=c(0,20),col=rainbow(42))
bptd1314 = barplot(avgbytermdegdept1314,main="Average Time Between Bachelers and Terminal Degree by Department 2013-2014",ylab="Time(Years)",las=2,ylim=c(0,15),col=rainbow(42))
@
