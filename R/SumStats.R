#' @name wcagepredssumstats
#' @title sumstats
#' @description Allows a user to find the summary statistics such as the minimum, first quartile, median, mean, third quartile, and maximum of the faculty age distribution at Williams College in a given academic year
...
#'@param sumstats When set to True displays the summary statistics of the Williams College faculty in the inputted academic year and when set to FALSE outputs the average age for that given academic year
