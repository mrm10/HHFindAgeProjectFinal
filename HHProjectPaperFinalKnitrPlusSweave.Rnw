...
<<echo=FALSE>>=
Fac0405 = read.csv("~/FinalProject2/HHFindAge/data/04 05 Faculty.csv")
Fac0506 = read.csv("~/FinalProject2/HHFindAge/data/05 06 Faculty.csv")
Fac0607 = read.csv("~/FinalProject2/HHFindAge/data/06 07 Faculty.csv")
Fac0708 = read.csv("~/FinalProject2/HHFindAge/data/07 08 Faculty.csv")
Fac0809 = read.csv("~/FinalProject2/HHFindAge/data/08 09 Faculty.csv")
Fac0910 = read.csv("~/FinalProject2/HHFindAge/data/09 10 Faculty.csv")
Fac1011 = read.csv("~/FinalProject2/HHFindAge/data/10 11 Faculty.csv")
Fac1112 = read.csv("~/FinalProject2/HHFindAge/data/11 12 Faculty.csv")
Fac1213 = read.csv("~/FinalProject2/HHFindAge/data/1213 Faculty.csv")
Fac1314 = read.csv("~/FinalProject2/HHFindAge/data/1314 Faculty.csv")
@
...
bpovertime = barplot(numberoffaculty,names.arg=c("2004-2005","2005-2006","2006-2007","2007-2008","2008-2009","2009-2010","2010-2011","2011-2012","2012-2013","2013-2014"),xlab="Academic Year",ylab="Number of Faculty", main="Number of Faculty Over Time(Disclaimer about Library)",ylim=c(0,500),las=2,col=topo.colors(10))
@
